    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-6 py-6">
          <Link href="/admin/albums" className="mb-2 text-sm text-blue-600 hover:underline">
            ← 앨범 목록
          </Link>
          <h1 className="text-3xl font-bold text-gray-900">새 앨범 등록</h1>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        <form onSubmit={handleSubmit} className="rounded-lg bg-white p-6 shadow">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <Link href="/admin/albums" className="rounded border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-50">
              취소
            </Link>
          </div>
        </form>
